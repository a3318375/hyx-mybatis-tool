...
public abstract class BaseGroupPanel extends JPanel {
    ...
    private String inputItemName(String initValue) {
        return Messages.showInputDialog(MyBundle.message("groupName"), MyBundle.message("title"), Messages.getQuestionIcon(), initValue, new InputValidator() {
            @Override
