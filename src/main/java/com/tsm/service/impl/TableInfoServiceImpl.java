...
public class TableInfoServiceImpl implements TableInfoService {
    ...
    public void save(TableInfo tableInfo) {
        ...
        if (content == null) {
            Messages.showWarningDialog(MyBundle.message("jsonSaveError"), MyBundle.message("title"));
            return;
        }
        // 获取或创建保存目录
        ...
        if (!dir.exists()) {
            if (!dir.mkdirs()) {
                Messages.showWarningDialog(MyBundle.message("noDirSaveError"), MyBundle.message("title"));
                return;
            }
        }
        // 获取保存文件
    ...
    private TableInfo parser(String str) {
        try {
            ...
            Messages.showWarningDialog(MyBundle.message("configSaveError"), MyBundle.message("title"));
            ExceptionUtil.rethrow(e);
        }
        return null;
    }
